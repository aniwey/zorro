...
void Interface::init(Screen& s, ConfigData& textStrings){
  ...
  mainToolbar.init(0, 0, 0, -72, s.getWidth(), 72, 0);
    ...
    mainToolbar.addButton(s.im, "air", textStrings.getIterator("menu_air"), -60, 0, pixelType_NONE, true);
    mainToolbar.addButton(s.im, "stone", textStrings.getIterator("menu_stone"), 60, 0, pixelType_NONE, true);
}
